...
const data: ContactItemData[] = [
  {
    title: "Địa chỉ",
    subtitle: "Lầu 1 Tòa nhà Saigon ICT, Lô 46 Công viên phần mềm Quang Trung",
    icon: (
  ...
  {
    title: "Email",
    subtitle: "vietducle.nasani@gmail.com",
    icon: (
